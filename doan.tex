...
\usepackage[top=2cm, bottom=2cm, left=3.5cm, right=2.5cm, includefoot]{geometry}
...
\lstset{breaklines=true,breakatwhitespace=true,basicstyle=\ttfamily\small} % Formatting code như C, C++, Python
...
\newpage
\subfile{05_Danh_muc_viet_tat}

\newpage
\subfile{06_Thuat_ngu}
% ===================================================
...
\markboth{MỘT SỐ LƯU Ý VỀ TÀI LIỆU THAM KHẢO}{}
